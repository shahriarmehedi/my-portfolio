...
import bgBanner from '../../../src/assets/images/wp7453603-portfolio-wallpapers2.png'
    ...
    return (
        <div id="home" style={{ backgroundImage: `url(${bgBanner})`, backgroundSize: "cover" }} className="h-screen bg-blue-500 text-white text-center lg:text-left ">
            <div className=" pt-64 lg:pt-80 lg:w-2/3 mx-auto">
                ...
                <a href="https://shahriar.work/RESUME_Md_Shahriar_Mehedi_27NOV.pdf" target="_blank" rel="noreferrer" hre className="hover:bg-gray-800 transition duration-500 mx-auto px-10 py-4  lg:px-12 lg:py-4  bg-green-500 rounded-full text-gray-900 hover:text-white">Download Resume</a>
            </div>
        </div>
    );
};
